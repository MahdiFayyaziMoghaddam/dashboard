...
import type { Language as L } from "@/types/language";
...
const Language = ({ items }: SelectProps) => {
  ...
  const [state, setState] = useState<LanguageItem>(items[0]);
    ...
    <S.Root items={items}>
      ...
      <S.Portal>
        ...
        <S.Positioner
          ...
          sideOffset={8}
        >
          <S.Popup className="p-[0.6rem] w-[25rem] border-main-light/8 border-1 rounded-[1.6rem] shadow-2xs bg-main-box transition-[transform,scale,opacity] data-[ending-style]:scale-90 data-[ending-style]:opacity-0 data-[side=none]:data-[ending-style]:transition-none data-[starting-style]:scale-90 data-[starting-style]:opacity-0 data-[side=none]:data-[starting-style]:scale-100 data-[side=none]:data-[starting-style]:opacity-100 data-[side=none]:data-[starting-style]:transition-none">
            {items.map(
